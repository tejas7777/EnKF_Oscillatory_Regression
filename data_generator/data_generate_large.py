...
n_features = 200    # Number of features in each theta vector
m_output = 1       # Dimension of the output vector should be 1 for regression
epsilon = 4.0      # Scale factor for the sinusoidal component
l = 21.0           # Frequency multiplier for the sinusoidal component
noise_std = 0.0   # Standard deviation for Gaussian noise

# Generate random matrices A and B of size 1x200
...
data.to_csv('oscillatory_data_large.csv', index=False)

# Save the true parameters
true_params = {'A': A, 'B': B}
np.save('../dataset/true_params.npy', true_params)

print("Data and true parameters saved.")
